...
@section('title', 'Create Purchase Order (Non-Tax) | Zareena Industries')
                            ...
                            <div class="col-md-6">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <input type="number" class="form-control text-end" id="labour_charges"
                                                name="labour_charges" value="0" min="0" step="0.01"
                                                style="width: 100%;">
                                        </td>
                                    </tr>
                                    <tr>
    ...
    <script>
        ...
        `;
            ...
            function calculateTotals() {
                ...
                const grandTotal = subtotal + labourCharges + freightCharges;
            ...
            // Labour and freight charges change
            document.getElementById('labour_charges').addEventListener('input', calculateTotals);
