...
<body>
    <div class="invoice-container">
        ...
        <div class="invoice-details">
            <div class="invoice-details-left">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $purchase->due_date ? $purchase->due_date->format('d-m-Y') : $purchase->created_at->format('d-m-Y') }}</span>
                </div>
                <div class="detail-row">
            ...
            <div class="invoice-details-right">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $purchase->po_no ? $purchase->created_at->format('d-m-Y') : 'N/A' }}</span>
                </div>
        ...
        <div class="vendor-info">
            ...
            <div class="vendor-details">
                ...
                {{--  <div class="vendor-detail-item">
                    ...
                    <span>{{ $purchase->vendor->ntn ?? 'N/A' }}</span>
                </div>
                 --}}
            </div>
        </div>
        ...
        <table class="products-table">
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-center"><strong>{{ number_format($purchase->products->sum('qty'), 2) }}</strong></td>
                    <td class="text-center">-</td>
                    <td class="text-right"><strong>{{ number_format($purchase->products->sum('total_amount'), 2) }}</strong></td>
                </tr>
            </tfoot>
        </table>
        ...
        <div style="text-align: center; margin-top: 20px; font-size: 10px; color: #666;">
            <p>Printed On: {{ now()->format('d/m/Y h:i:s A') }}</p>
        </div>
    </div>
