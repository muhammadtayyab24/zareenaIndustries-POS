...
@section('title', 'Edit Customer | Zareena Industries')
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <form method="POST" action="{{ route('customers.update', $customer->id) }}" class="my-4">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                    ...
                                    <option value="Cash" {{ old('type', $customer->type) == 'Cash' ? 'selected' : '' }}>Cash</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('ntn') is-invalid @enderror" 
                                       id="ntn" name="ntn" value="{{ old('ntn', $customer->ntn) }}">
                                @error('ntn')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
