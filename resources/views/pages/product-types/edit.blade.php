...
@section('title', 'Edit Product Type | Zareena Industries')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('product-types.index') }}" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="card-body pt-0">
                ...
                <form method="POST" action="{{ route('product-types.update', $productType->id) }}" class="my-4">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                    <option value="1" {{ old('status', $productType->status) == 1 ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ old('status', $productType->status) == 0 ? 'selected' : '' }}>Inactive</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-end">
                                ...
                                <a href="{{ route('product-types.index') }}" class="btn btn-secondary px-4">
