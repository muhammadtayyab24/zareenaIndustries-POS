...
@section('title', 'Create Product Type | Zareena Industries')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="card-title">Create New Product Type</h4>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body pt-0">
                ...
                <form method="POST" action="{{ route('product-types.store') }}" class="my-4">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
