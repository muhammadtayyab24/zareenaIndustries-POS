...
@section('title', 'Create Sales Order (Tax) | Zareena Industries')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                    <h4 class="card-title">Create Sales Order (Tax)</h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        onclick="window.location.href='{{ route('sales-orders.tax.index') }}'">
            ...
            document.getElementById('salesOrderForm').addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    if (!response.ok) {
                        ...
                        let errorMsg = result.message || 'Error creating sales order';
                        if (result.errors) {
                    ...
                    alert('An error occurred while creating sales order: ' + (error.message || 'Unknown error'));
                    console.error('Error:', error);
                    saveBtn.disabled = false;
                    saveBtn.innerHTML = '<i class="las la-save"></i> Save';
                }
