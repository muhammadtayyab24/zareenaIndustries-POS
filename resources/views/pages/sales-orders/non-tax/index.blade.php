...
@section('title', 'Sales Orders (Non-Tax) | Zareena Industries')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="card-title">Sales Orders (Non-Tax)</h4>
                    </div>
                    <div class="col-auto">
                        <a href="{{ route('sales-orders.non-tax.create') }}" class="btn btn-primary">
