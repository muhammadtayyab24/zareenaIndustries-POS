...
@section('title', 'Create Employee | Zareena Industries')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('monthly_salary') is-invalid @enderror" 
                                       id="monthly_salary" name="monthly_salary" value="{{ old('monthly_salary') }}" min="0">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('ot_rate_per_hour') is-invalid @enderror" 
                                       id="ot_rate_per_hour" name="ot_rate_per_hour" value="{{ old('ot_rate_per_hour') }}" min="0">
