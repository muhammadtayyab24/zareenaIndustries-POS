...
@section('title', 'Expense Categories Management | Zareena Industries')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="card-title">Expense Categories Management</h4>
                    </div>
                    <div class="col-auto">
...
<script>
    ...
    document.getElementById('categoryForm').addEventListener('submit', function(e) {
        ...
        const url = categoryId ? `/expense-categories/${categoryId}` : '/expense-categories';
    ...
    document.querySelectorAll('.status-toggle').forEach(function(toggle) {
        toggle.addEventListener('change', function() {
            ...
            fetch(`/expense-categories/${categoryId}/toggle-status`, {
                method: 'POST',
                headers: {
    ...
    document.querySelectorAll('.delete-category').forEach(function(deleteBtn) {
        deleteBtn.addEventListener('click', function(e) {
            ...
            document.getElementById('deleteForm').action = `/expense-categories/${categoryId}`;
