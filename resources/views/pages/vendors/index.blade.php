...
@section('title', 'Vendors Management | Zareena Industries')
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('vendors.create') }}" class="btn btn-primary">
                            <i class="fas fa-plus-circle me-1"></i> Create New Vendor
                        </a>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-switch form-switch-success">
                                            ...
                                            <label class="form-check-label" for="status_{{ $vendor->id }}">
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex gap-2 justify-content-end">
                                            ...
                                            <a href="#" class="btn btn-sm btn-danger delete-vendor"
                                                data-vendor-id="{{ $vendor->id }}"
                                                data-vendor-name="{{ $vendor->name }}" data-bs-toggle="tooltip"
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="text-center py-3">
                <p class="mb-0 text-muted">Are you sure you want to delete vendor <strong id="deleteVendorName"></strong>?</p>                                                   
            </div><!--end modal-body-->
...
<script>
    ...
    // Delete Vendor
    document.querySelectorAll('.delete-vendor').forEach(function(deleteBtn) {
        deleteBtn.addEventListener('click', function(e) {
            ...
            document.getElementById('deleteForm').action = `/vendors/${vendorId}`;
